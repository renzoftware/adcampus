...
<div class="row">
 	<div class="x_panel">
 		<div class="x_title">
 			<div class="col-md-6">
        <h3 class="r_h3">Control <b>Usuarios</b>&nbsp;</h3> 
        <button class="btn btn-success" data-toggle="modal" href="#addUserModal"><i class="glyphicon glyphicon-plus"></i> Nuevo</button>
      </div>
    ...
    <div class="x_content">
		  <div id="loader_user"></div><!-- Carga de datos ajax aqui -->
	...
	<!-- Add Modal HTML -->
	<?php include("modal_user_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("modal_user_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php include("modal_user_delete.php");?>

<script src="../res/js/script_user.js"></script>